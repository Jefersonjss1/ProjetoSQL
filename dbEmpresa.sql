...
select * from produtos where tipo = 'ELETRONICOS' and valor < 600.00;
...
select * from produtos where valor not between 400.00 and 600.00;

select * from produtos where nome like '%l';
